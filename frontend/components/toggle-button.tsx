  ...
  return (
    <button
      ...
      className={`px-3 py-1 rounded border transition
        ${
          buttonSelected
            ? "bg-[#f4f3f1] hover:bg-[#426E55]/80 border border-gray-300 shadow-md duration-300 cursor-pointer"
            : " hover:bg-[#426E55]/80 border border-gray-300 shadow-md duration-300 cursor-pointer"
        }`}
